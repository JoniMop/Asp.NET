...
namespace DataAcess.Crud
{
    public class ViajeCrudFactory : CrudFactory
    {
        ...
        public override void Create(BaseEntity entity)
        {
            ...
            var sqlOperation = mapper.GetCreateStatement(viaje);
        ...
        {
            var viaje = (Viaje)entity;
            dao.ExecuteProcedure(mapper.GetUpdateStatement(viaje));
        }

        public override void Delete(BaseEntity entity)
        {
            var viaje = (Viaje)entity;
            dao.ExecuteProcedure(mapper.GetDeleteStatement(viaje));
        }
